...
// Internal structures and helper functions for testing
...
// Helper functions for setting comments (used internally and for testing)
void _setComment(Value& val, void (Value::*fp)(const std::string&),
